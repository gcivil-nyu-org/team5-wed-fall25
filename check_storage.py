...
print(
    f"   settings.DEFAULT_FILE_STORAGE: {getattr(settings, 'DEFAULT_FILE_STORAGE', 'Not set')}"
)
...
storage_location = (
    str(profile_photo_field.storage.location)
    if hasattr(profile_photo_field.storage, "location")
    else "N/A"
)

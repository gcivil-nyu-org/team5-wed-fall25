// communities/static/communities/js/chat.js
// JavaScript for community chat with AJAX polling
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Get community slug and user info from data attributes
    const communitySlug = messagesContainer.dataset.communitySlug;
    ...
    function createMessageHTML(message) {
        ...
        // Message bubble
        const editedBadge = message.is_edited ? '<span class="message-separator">•</span><span class="edited-badge">Edited</span>' : '';
        html += `
    ...
    function pollNewMessages() {
        ...
        const url = `/communities/${communitySlug}/chat/poll/?last_message_id=${lastMessageId}`;

...
urlpatterns = [
    ...
    path("roommates/<int:user_id>/favorite/", views.toggle_favorite, name="toggle_favorite"),
    path("roommates/<int:user_id>/request/", views.send_connection_request, name="send_connection_request"),
    ...
    path("roommates/requests/<int:request_id>/respond/", views.respond_to_request, name="respond_to_request"),
]
